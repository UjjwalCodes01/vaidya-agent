 ...
 * 
 * NOTE: This runs in Edge Runtime - all imports must be Edge-compatible
 */
...
import {
  ...
  getRateLimitHeaders,
  getClientIP,
} from './lib/security/rate-limiter-edge';
...
/**
 * Proxy function (Next.js 16+ convention, previously called middleware)
